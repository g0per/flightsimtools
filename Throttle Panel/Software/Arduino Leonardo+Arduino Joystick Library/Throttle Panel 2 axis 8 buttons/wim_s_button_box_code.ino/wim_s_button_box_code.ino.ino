...
#define NUMBUTTONS 8 //replace "?"with number of buttong you are using
...
byte rowPins[NUMROWS] = {0,1,2}; //change "?" to the pins the rows of your button matrix are connected to
